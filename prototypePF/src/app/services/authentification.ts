...
//     this.authWindow.webContents.on('will-navigate', (event: any, url:any) => {
//       this.handleGitHubCallback(url);
//     });

//     this.authWindow.webContents.on('did-get-redirect-request', (event:any, oldUrl:any, newUrl:any) => {
...
//    */
//   requestGithubToken(githubOptions:any, githubCode:string) {
